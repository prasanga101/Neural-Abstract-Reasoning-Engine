    ...
    def _check_required_outputs(self, state, execution_trace):
        ...
        for step in execution_trace:
            ...
            if status == "completed":
                ...
                if expected_env_key and expected_env_key not in state:
